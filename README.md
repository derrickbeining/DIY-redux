...
#### Foot note
We do not implement the `bindActionCreators` and `combineReducers` functions, which are both part of the redux library. If you are curious, feel free to dig through their source code and try to implement it yourself! 
